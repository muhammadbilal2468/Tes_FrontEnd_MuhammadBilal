  ...
  return (
    <>
      <div className="mb-10">
        ...
        <div className="grid xl:grid-cols-4 grid-cols-2 gri gap-10">
          <div className="flex flex-col gap-2 cursor-pointer border-b-2 pb-2">
            <img
            ...
            <div className="flex flex-col gap-2">
              <div className="flex xl:text-xs text-[9px] gap-1 justify-between">
                <p className="font-bold">Perang Ukraina</p>
                <p className="">Atuhor: Bilal</p>
              </div>
